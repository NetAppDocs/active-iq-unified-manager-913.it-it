...
* Red Hat Enterprise Linux versioni 7.x e dalla 8.0 alla 8.7, basato sull'architettura x86_64.
...
* MySQL Community Edition versione 8.0.32 (dal repository MySQL).
* OpenJDK versione 11.0.18 (dall'archivio Red Hat Extra Enterprise Linux Server)
* Python 3,6.x
