...
| Nome evento (nome trap) | Livello di impatto | Tipo di origine | Severità 
 ...
 a| 
Monitoraggio anti-ransomware del volume abilitato (Active Mode)
...
Informazioni
 ...
 a| 
Monitoraggio anti-ransomware del volume disabilitato
(AntiRansomwareVolumeStateDisabilitato)
 a| 
Rischio
 a| 
Volume
...
Attenzione
 ...
 a| 
Monitoraggio anti-ransomware del volume abilitato (Learning Mode)
...
Informazioni
 ...
 a| 
Monitoraggio anti-ransomware del volume sospeso (Learning Mode)
...
Attenzione
 ...
 a| 
Monitoraggio anti-ransomware del volume sospeso (Active Mode)
...
Attenzione
 ...
 a| 
Il monitoraggio anti-ransomware del volume è disattivato
