...
** Arancione: "Errore" (indica eventuali errori interni, quali eccezioni, errori nella raccolta dei dati di configurazione o impossibilità di raggiungere vCenter Server)
È possibile fare clic sull'icona di visualizzazione delle colonne (*Mostra/Nascondi*) per visualizzare il messaggio di stato relativo allo stato di vCenter Server e risolvere il problema.
